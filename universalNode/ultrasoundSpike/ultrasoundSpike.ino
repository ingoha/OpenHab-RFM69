const int trigger = 7; //Trigger-Pin des Ultraschallsensors an Pin7 des Arduino-Boards
const int echo = 6; // Echo-Pim des Ultraschallsensors an Pin6 des Arduino-Boards
